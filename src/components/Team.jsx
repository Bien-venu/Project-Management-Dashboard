  ...
  return (
    ...
    >
      <li className="relative h-6 w-6 overflow-hidden">
        ...
        />
        <span className=" bg-active absolute right-0 top-0 h-2 w-2 rounded-full border border-white"></span>
      </li>
      <li className="relative h-6 w-6 overflow-hidden">
        <img
          src={image2}
      ...
      <li className="relative flex h-6 w-6 items-center justify-center overflow-hidden rounded-full border border-dashed">
        <svg
